document.addEventListener("turbo:load", function () {
    ...
    // Sécurité : si les éléments n'existent pas sur cette page, on arrête
    if (!cartBtn || !cartDrawer) return;

    // ✅ Affichage immédiat du badge depuis le stockage local
    const storedCount = parseInt(sessionStorage.getItem("cartCount") || "0");
    ...
    function renderCart(data) {
        ...
        cartItems
            .querySelectorAll(".cart-item__qty-select")
            .forEach((select) => {
    ...
    function updateBadge(count) {
        ...
        // ✅ On mémorise le count pour la prochaine navigation
